...
5. Sean's review of flagged claims becomes calibration data (see [[Calibration-via-Operator-Feedback]]).
...
- [[Calibration-via-Operator-Feedback]] — using Sean's corrections to calibrate verification
