...
created: 2026-07-26
summary: "Annotated example of a good chat response to Sean — bottom-line-up-front, concise, cited, accomplishment-focused."
tags: [exemplar, chat-response, communication, how-to]
---

<!-- EXEMPLAR ANNOTATION: CHAT RESPONSE
     This note is an exemplar for how to respond to Sean in chat. When the model
     is about to respond to Sean, FUSED retrieval should surface this note. The
     model reads the annotated example and pattern-matches against it.

     Key principles (from [[Sean-Communication-Preferences]]):
...
Sean asks: "did you finish the research on context budgeting?"

## Good Response

<!-- ANNOTATION: Lead with the answer. Yes or no, then details. Don't make Sean read 3 paragraphs to find out if it's done. -->
...
<!-- ANNOTATION: If there's a next step or decision point, state it briefly. Don't ask permission — per [[Autonomy-Directive]], report after the fact. But do flag anything that needs Sean's input. -->
...
## Related
- [[Sean-Communication-Preferences]] — the source of these rules
