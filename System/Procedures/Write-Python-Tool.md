...
Run this procedure when you need to create a new tool — a capability you don't have that would help you or Sean. Covers the full lifecycle: identify the gap, write the code, test it, deploy it, verify it.
