...
def run(args: dict) -> dict:
    ...
    if tmp_path.exists():
        ...
        results.append(
            "identity.py: copied .tmp fix over original (backup in trash/backups/)"
        )
    else:
    ...
    "tool_create",
        ...
        if old_core in content:
            ...
            results.append(
                "agent_tools.py: expanded CORE_TOOL_NAMES to include all tools"
            )
        else:
            errors.append(
                "agent_tools.py: could not find CORE_TOOL_NAMES block to replace"
            )
...
CONTEXTUAL_TOOL_CATEGORIES: dict[str, list[str]] = {}"""
    ...
    if custom_schemas:'''
        ...
        if old_build in content:
            ...
            errors.append(
                "agent_tools.py: could not find build_tool_list block to replace"
            )
    ...
    return set()'''
        ...
        if old_select in content:
            ...
            results.append(
                "agent_tools.py: made select_contextual_categories a no-op (deprecated)"
            )
        else:
            errors.append(
