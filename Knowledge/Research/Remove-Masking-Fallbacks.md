...
- Remove failure-masking shell constructs and validate `
...
- Observe logs and responses returned by the service endpoints (e.g., summarization/chat endpoints).  [sources: [BUG]: Overly broad catch (Exception) blocks swallow errors and reduce observability Description]
