...
# learningMaterial/ lives at the framework root (user-supplied PDFs).
# Knowledge/Textbooks/ lives inside the vault under vaultbot-stuff/.
VAULT_DIR = FRAMEWORK_ROOT
BACKEND_DIR = FRAMEWORK_ROOT / "vaultbot_backend"
LEARNING_DIR = FRAMEWORK_ROOT / "learningMaterial"
TEXTBOOKS_DIR = VAULT_ROOT / "vaultbot-stuff" / "Knowledge" / "Textbooks"
