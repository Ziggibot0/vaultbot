...
SCHEMA = {
    ...
    "description": (
        ...
        "'vaultbot-stuff/Knowledge/Research/My-Note.md'). Only user-personal notes "
        "go in User/ (e.g. 'User/VaultBot Issues.md'). VaultBot's own "
        "directives and identity notes live under vaultbot-stuff/System/Identity/ "
        "(e.g. 'vaultbot-stuff/System/Identity/Autonomy-Directive.md'). NEVER create "
        ...
        "properties": {
            ...
            "file_path": {
                "description": (
                    ...
                    "vaultbot-stuff/System/Identity/ (e.g. "
                    "'vaultbot-stuff/System/Identity/Autonomy-Directive.md'). NEVER "
...
def _is_root_directive(file_path: str) -> bool:
    ...
    Directives belong under vaultbot-stuff/System/Identity/, never at the root.
...
def run(args: dict) -> dict:
    ...
    # vaultbot-stuff/System/Identity/, never at the vault root.
    if _is_root_directive(file_path_str):
        result["blocked_reason"] = (
            f"Root-level directive blocked: {file_path_str}. "
            "VaultBot directives belong under vaultbot-stuff/System/Identity/."
        )
        return result
