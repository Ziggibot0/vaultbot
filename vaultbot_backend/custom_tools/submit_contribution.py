...
def run(args: dict) -> dict:
    ...
    backend_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "vaultbot_backend")
    ...
    # Find the vault root (parent of vaultbot_backend/)
    vault_root = os.path.dirname(backend_dir)
