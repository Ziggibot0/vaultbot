...
SCHEMA = {
    "name": "thought",
    "description": (
        "Tool for internal reasoning and reflection. Use this to think "
        "through problems, plan steps, or evaluate your state before taking "
        "external action. Unlike other tools, calling 'thought' does NOT "
        "trigger a premature loop termination or speech trap detection. It is "
        "the designated safe space for LLM cognition."
    ),
    "parameters": {
        "properties": {
