...
SCHEMA = {
    ...
    "description": (
        ...
        "under vaultbot/ (e.g. 'vaultbot-stuff/Knowledge/Research/My-Note.md'). "
        ...
        "'vaultbot-stuff/System/Identity/Autonomy-Directive.md'). NEVER create "
...
def _is_root_directive(file_path: str) -> bool:
    ...
    Directives belong under vaultbot/ (e.g. vaultbot-stuff/System/Identity/ or
    vaultbot-stuff/baseline/), never at the vault root. A root-level directive is
    ...
    if _is_root_directive(file_path):
        return {
            "error": (
                ...
                "vaultbot-stuff/System/Identity/)."
            )
        }
