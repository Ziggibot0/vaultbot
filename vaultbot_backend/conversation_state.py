...
# 80 messages / 20k tokens; this is a hard ceiling for the disk copy so a
# vault that runs for months doesn't accumulate a multi-MB conversation file.
# Each turn is a few hundred chars to a few KB, so 80 turns ≈ 100-300 KB.
MAX_TURNS = 80
