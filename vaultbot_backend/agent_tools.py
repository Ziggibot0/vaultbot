...
def build_system_prompt_briefing(
    ...
    return (
        ...
        f"Use the retrieved procedure surface in the system context as your "
        f"routing surface. It is built from FUSED retrieval for this turn; "
        f"choose procedures from that context when they fit, and otherwise "
        f"use tools directly.\n"
