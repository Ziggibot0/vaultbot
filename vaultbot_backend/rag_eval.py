...
ground truth is available (from Sean's corrections or manual annotation).
...
class RAGEvaluator:
    ...
    - Sean's corrections ("you missed X" -> X should have been retrieved)
    ...
    def add_ground_truth(self, query: str, relevant_notes: list[str]) -> None:
        ...
        - Sean's corrections ("you missed X" -> X should have been retrieved)
        - Manual annotation (Sean or VaultBot marks expected results)
